...
While I've spent plenty of time on machine learning projects in the past, I believe Stable Diffusion, the diffusers library, and their extended applications have the potential to disrupt many industries. For the foreseeable future I am devoting my time to working on related projects (g-diffuser-lib et al).
